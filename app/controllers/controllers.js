...
.controller("myController",["$scope","$state","home_scroll","$location","$anchorScroll","home_getInfo","$rootScope",function($scope,$state,home_scroll,$location,$anchorScroll,home_getInfo,$rootScope){
...
//list
.controller('mydatahotselling',['$scope','goods_myhotselling_service',function($scope,goods_myhotselling_service){
        goods_myhotselling_service.getData().success(function(data){
			$scope.hotsellinggoodslist=data.operation.search2_list;
		})    
}])
